...
/*
            var str = '<tr>' +
                '<td>' + templateRate.startValue + '</td>'+
                '<td><span style="color:red">原有信息(' + oldTemplateRate.startValue + ')</span></td>'+
                '<td>' + templateRate.endValue + '</td>'+
                '<td><span style="color:red">原有信息(' + oldTemplateRate.endValue + ')</span></td>'+
                '<td>' + templateRate.rateValue + '</td>'+
                '<td><span style="color:red">原有信息(' + oldTemplateRate.rateValue + ')</span></td>'+
                '</tr>';*/
            var str = '';
    ...
    function saveTemplateName() {
        var newName = $("#newnewnewName").val();
        var data = {startMonth:'${applyDetail.startMonth}',endMonth:'${applyDetail.endMonth}',applyId:'${templateRecode.templateId}',id:'${templateRecode.id}',busNum:'${templateRecode.busNum}',newName:newName,applyDetail:'${applyDetail}',
            orgTemplatePriceList:'${applyTemplatePriceList}',orgTemplateRateList:'${applyTemplateRateList}'};
        $.ajaxL({
            type: "POST",
    ...
    <form id="profit_template_form">
        <div style="line-height: 17px;margin-top: 17px;" >
            ...
            <shiro:hasPermission name="/templateApply/andBussiness">
                <span>
                    &nbsp;&nbsp; &nbsp; &nbsp;新模板名称：&nbsp;&nbsp; &nbsp; &nbsp;
                    <input type="text" id="newnewnewName" value="${applyDetail.templateName}">
                    <a href="javascript:void(0);" class="easyui-linkbutton"
                       data-options="iconCls:'icon-save',plain:true" onclick="saveTemplateName();">保存新名称</a>
                </span>
            </shiro:hasPermission>
        ...
        <div style="line-height: 17px;margin-top: 17px;" >
            <table id="priceTable" class="editTable" style="width:700px;padding-top: 17px;overflow:hidden;overflow-y:auto;" border="1" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <th style="text-align: center;">规则值<span></span></th>
