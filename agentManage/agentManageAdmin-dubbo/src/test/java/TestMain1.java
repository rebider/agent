...
public class TestMain1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            par.put("authCode","7269a45c179f4631b6e3773d2967cf93");
            par.put("agAccount","AG20023754008");
            par.put("agPassword","xaXvzD+F+tTwiJHrT/EUBA==");
            ...
            reqmap.put("param",s);
            String s1 = HttpClientUtil.doPost("http://12.3.10.205:8082/ag/login", reqmap);
