...
public class ToolsDeductJobTest {
    ...
    public void computeToolsDeduct() throws Exception {
        ...
        map.put("agentPid", "AG20180809000000000005962"); //AG20180813000000000006020
        map.put("paltformNo", "100002");        //平台编号
        map.put("deductDate", "2019-03");       //扣款月份
        map.put("agentProfitAmt", "500");        //代理商分润
