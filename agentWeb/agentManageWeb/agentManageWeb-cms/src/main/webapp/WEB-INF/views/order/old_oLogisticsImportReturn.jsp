...
<script type="text/javascript">
    $(function () {
        $('#old_logisticsImportFileForm').form({
            ...
            success: function (result) {
                ...
                if(data.resCode=='1'){
                    ...
                    old_order_return_bus_wuliu_table.datagrid('reload');
                }else{
                    if( data.obj != undefined && data.obj.length > 0 ){
                      var msg = [];
                      if( data.obj.length > 0 ){
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;">
        <form id="old_logisticsImportFileForm" method="post" enctype="multipart/form-data">
            <input type="hidden" name="requestType" value="old_orderReturn">
            <table class="grid" id="">
                <tr>
                    <td>
