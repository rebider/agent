        ...
        <form id="activityEditForm" method="post">
            ...
            <table class="grid">
                <tr>
                    ...
                    <td>原价：</td>
                    <td ><input name="originalPrice" maxlength="15"  id="originalPrice" type="text" placeholder="请输入" value="${oActivity.originalPrice}"
                ...
                <tr>
                    <td>特价机价格</td>
                    <td><input name="posSpePrice" id="posSpePrice" maxlength="15" id="posSpePrice" type="text" placeholder="请输入" class="easyui-numberbox"
                               style="width:160px;" value='${oActivity.posSpePrice}' ></td>
                    </td>
                    <td>达标时间（天）</td>
                    <td><input name="standTime" maxlength="15" id="standTime" type="text" placeholder="请输入" class="easyui-numberbox"
