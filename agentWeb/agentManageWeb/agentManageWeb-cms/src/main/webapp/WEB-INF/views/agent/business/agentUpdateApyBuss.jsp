...
<%@ include file="editAgentBasics_model_buss.jsp" %>
<%@ include file="queryAttachment_model_buss.jsp" %>
<%@ include file="editAgentBusi_model_buss.jsp" %>
...
<script type="text/javascript">
    ...
    function saveAgentEnterEditApy(){
        var agent =get_editAgentBasics();
        var editAgentBusiTable =(typeof get_editAgentBusiTable_FormData=== "function")?get_editAgentBusiTable_FormData():[];
        var AgentBase_AttFile_model_formFiles = (typeof get_addAttAgentcapitalTable=== "function")?get_addAttAgentcapitalTable():[];
        console.log(AgentBase_AttFile_model_formFiles+"------------")
