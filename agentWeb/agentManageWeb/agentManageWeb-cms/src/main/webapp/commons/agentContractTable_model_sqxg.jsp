    ...
    <table  class="grid">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="javascript:void(0)" class="editAgentContractTableAddAttr-easyui-linkbutton-edit" data-options="plain:true,iconCls:'fi-magnifying-glass'" onclick="addAgentContractTable_uploadView(this)" >合同变更表</a>
            </td>
        </tr>
        </tbody>
    </table>
