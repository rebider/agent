...
import com.ryx.credit.cms.shiro.ShiroDbRealm;
...
public class CUserController extends BaseController {
    ...
    public Object dataGrid(UserVo userVo, Integer page, Integer rows, String sort, String order) {
        ...
        return userService.selectDataGrid(pageInfo);
    }
    ...
    public Object login(final HttpServletRequest request,
        ...
        hashSet.add("/activity/toList.htmls");
        HashSet<String> hashSet2 = new HashSet<>();
        hashSet2.add("外部人员");
        ShiroUser shiroUser = new ShiroUser(id,name,name,hashSet);
        shiroUser.setRoles(hashSet2);
