...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="terminalLinkEditForm" method="post">
            <table class="grid">
                <tr>
	                <td style="width:120px;">终端ID</td>
	                <td colspan="1">
	                <input name="terminalProductId" type="hidden"  value="${cterminalProduct.terminalProductId}">
	                <select id="LinkTerminalId" name="terminalId" style="width:170px;height: 24px;" data-options="required:true"></select>
	                <a class="easyui-linkbutton" href="javascript:void(0)" onclick="$('#LinkTerminalId').combotree('clear');" >清空</a></td>
            	</tr>
            	<tr>
	                <td>产品</td>
	                <td colspan="1"><select id="LinkProductId" name="parentProductId" style="width:170px;height: 24px;" data-options="required:true"></select>
