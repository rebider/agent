...
public class AgentCertifiVo implements Serializable {
    private String id;
    ...
    private String orgAgBusLicb;

    private String orgAgBusLice;
    ...
    public String getReqCerTm() {
        return reqCerTm;
    }

    public void setReqCerTm(String reqCerTm) {
    ...
    public String getOrgAgBusLicb() {
        return orgAgBusLicb;
    }

    public void setOrgAgBusLicb(String orgAgBusLicb) {
        this.orgAgBusLicb = orgAgBusLicb;
    }

    public String getOrgAgBusLice() {
        return orgAgBusLice;
    }

    public void setOrgAgBusLice(String orgAgBusLice) {
    ...
    public String getCerProStatMark() {
        return cerProStatMark;
    }
