...
public class JoOrder {
    ...
    private String acceptBranch;

    private String acceptNowBranch;
    ...
    public void setAcceptBranch(String acceptBranch) {
        this.acceptBranch = acceptBranch == null ? null : acceptBranch.trim();
    }

    public String getAcceptNowBranch() {
        return acceptNowBranch;
    }

    public void setAcceptNowBranch(String acceptNowBranch) {
        this.acceptNowBranch = acceptNowBranch == null ? null : acceptNowBranch.trim();
    }
