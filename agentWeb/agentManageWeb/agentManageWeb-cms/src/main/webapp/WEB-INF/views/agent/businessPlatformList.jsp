...
<script type="text/javascript">
    ...
    $(function() {
        businessPlat = $('#businessPlat').datagrid({
            url : '${path }/business/queryBusinessPlatform',
            striped : true,
            rownumbers : true,
            pagination : true,
            singleSelect : true,
            ...
            columns : [ [{
                ...
                formatter : function(value, row, index) {
                    ...
                    if(row.CLO_REVIEW_STATUS=='3' && row.BUS_STATUS=='1'){
						...
						<shiro:hasPermission name="/agent/baseinfoappy">
							str += $.formatString('<a href="javascript:void(0)" class="bussz-sjxgsq-easyui-linkbutton-edit" data-options="plain:true,iconCls:\'fi-magnifying-glass\'" onclick="busDataChangeAppy(\'{0}\',\'agent\');" >申请修改</a>', row.ID);
						</shiro:hasPermission>
                    }
            ...
            onLoadSuccess:function(data){
                ...
                $('.bussz-sjxgsq-easyui-linkbutton-edit').linkbutton({text:'申请修改'});
