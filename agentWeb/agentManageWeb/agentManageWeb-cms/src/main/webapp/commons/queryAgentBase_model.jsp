...
<div class="easyui-panel" title="代理商基本信息"  data-options="iconCls:'fi-results'">
    <table class="grid" style="table-layout: fixed">
        ...
        <tr>
            ...
            <td>备注</td>
            <td colspan="5" SCAN="TRUE" MODEL="AGENT" MODELID="${agent.id}" MODELKEY="AGREMARK">
                ${agent.agRemark}
            </td>
            </shiro:hasPermission>
            <shiro:hasPermission name="/base/agStatus">
            <td>审批状态</td>
            <td SCAN="TRUE" MODEL="AGENTCONTRACTS" MODELID="${agent.id}" MODELKEY="CLOREVIEWSTATUS">
