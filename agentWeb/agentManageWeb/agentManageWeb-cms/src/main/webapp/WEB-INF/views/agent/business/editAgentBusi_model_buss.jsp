                ...
                <div title="代理商业务">
                    <table  class="grid">
                        <tr >
                            ...
                            <td>业务平台编号</td>
                            <td><input name="busNum" id="busNums" type="text" disabled="true" class="easyui-validatebox"  style="width:200px;"  data-options="validType:'length[1,32]'" value="${agentBusInfos.busNum}"  /></td>
                            </c:if>
                            <td>类型</td>
                            <td>
                                <select name="busType" style="width:200px;height:21px" onchange="busTypeSelect($(this).parent().prev().prev().find('#busNums'),this)" id="busTypeSelect" <c:if test="${appEditFlag=='1'}"></c:if>>
                        ...
                        <%--<tr >--%>
                            <%--<td>是否直接返现</td>--%>
                            <%--<td>--%>
                                <%--<select id="busDirectCashback1" name="busDirectCashback" style="width:160px;height:21px"  <shiro:lacksPermission name="/agentEnter/agentEdit/AgentBusiInfo"> disabled="true" </shiro:lacksPermission> >--%>
                                    <%--<c:forEach items="${yesOrNo}" var="yesOrNoItem"  >--%>
                            ...
                            <%--<td>是否要求收据</td>--%>
                            <%--<td>--%>
                                <%--<select id="cloReceipt1" name="cloReceipt" style="width:160px;height:21px"  <shiro:lacksPermission name="/agentEnter/agentEdit/AgentBusiInfo"> disabled="true" </shiro:lacksPermission> >--%>
                                    <%--<c:forEach items="${yesOrNo}" var="yesOrNoItem"  >--%>
                                ...
                                <select id="agentAssProtocol1" name="agentAssProtocol" style="width:110px;height:21px" onchange="assProSelect(this)" <shiro:lacksPermission name="/agentEnter/agentEdit/AgentBusiInfo"> disabled="true" </shiro:lacksPermission>>
                                    ...
                                    <c:forEach items="${ass}" var="assListItem"  >
                                        <option value="${assListItem.id}"
                                                <c:if test="${assListItem.id==agentBusInfos.assProtocolMap.ID}">
                                                    selected="selected"
                                                </c:if>
                                        >${assListItem.protocolDes}</option>
                                    </c:forEach>
                                </select>
                                <c:if test="${agentBusInfos.assProtocolMap.ID=='2' || agentBusInfos.assProtocolMap.ID=='3'}">
                                    <input name='protocolRuleValue' id='protocolRuleValue' class='easyui-validatebox' style='width:70px;' value="${agentBusInfos.assProtocolMap.PROTOCOL_RULE_VALUE}"
                                           placeholder='<c:if test="${agentBusInfos.assProtocolMap.ID=='2'}">台</c:if><c:if test="${agentBusInfos.assProtocolMap.ID=='3'}">元</c:if>' >
                                </c:if>
                            </td>--%>
                            <td>财务编号</td>
                        ...
                        <tr>
                            ...
                            <td>是否有效</td>
                            <td>
                                <select name="status" style="width:160px;height:21px" id="status1" disabled="true">
                                    <c:forEach items="${yesOrNoIsYes}" var="yesOrNoItem"  >
    ...
    <div title="业务">
        <table  class="grid">
            <tr >
                ...
                <td>业务平台编号</td>
                <td><input name="busNum" id="busNum" disabled="true" type="text"  input-class="easyui-validatebox"  style="width:200px;"  data-options="validType:'length[1,32]'"/></td>
                <td>类型</td>
                <td>
            ...
            <tr >
              ...
              <%--  <td>投诉及风险风控对接邮箱</td>
                <td><input id="busRiskEmail2" name="busRiskEmail" type="text"  input-class="easyui-validatebox"  style="width:160px;"  data-options="required:true,validType:'Email'"></td>--%>
            </tr>
            <tr >
                <td>业务联系人</td>
                ...
                <%--<td>分润对接邮箱</td>
                <td><input id="busContactEmail2" name="busContactEmail" type="text"  input-class="easyui-validatebox"  style="width:160px;" data-options="required:true,validType:'Email'"></td>--%>
                <td>业务对接人</td>
            ...
            <tr>
                ...
                <td>是否有效</td>
                <td>
                    <select name="status" style="width:160px;height:21px" id="status2" disabled="true">
                        <c:forEach items="${yesOrNoIsYes}" var="yesOrNoItem"  >
                            <option value="${yesOrNoItem.dItemvalue}">${yesOrNoItem.dItemname}</option>
                        </c:forEach>
                    </select>
...
//        if (busType==2 || busType==6) {
//            $("#busTypeSelect").parent().parent().parent().find("#busTypeSelect").attr("disabled", true);
//            $("#busTypeSelect").parent().parent().parent().find("#busTypeSelect").nextAll().attr("style","display: none");
//        }
        if (busType==2 || busType==6){
            $("#busType").parent().parent().parent().find("#busParent3").attr("disabled", true);
            $("#busType").parent().parent().parent().find("#busParent3").nextAll().attr("style","display: none");
            $("#busType").parent().parent().parent().find("#busRiskParent1").attr("disabled", true);
            $("#busType").parent().parent().parent().find("#busRiskParent1").nextAll().attr("style","display: none");

            $("#busType").parent().parent().parent().find("#busActivationParent3").attr("disabled", true);
            $("#busType").parent().parent().parent().find("#busActivationParent3").nextAll().attr("style","display: none");

            $("#busType").parent().parent().parent().find("#busParent3").val("");
            $("#busType").parent().parent().parent().find("#busParent4").attr("value","");
            $("#busType").parent().parent().parent().find("#busRiskParent1").val("");
            $("#busType").parent().parent().parent().find("#busRiskParent2").attr("value","");
            $("#busType").parent().parent().parent().find("#busActivationParent3").val("");
            $("#busType").parent().parent().parent().find("#busActivationParent4").attr("value","");
        }else{
            $("#busType").parent().parent().parent().find("#busParent3").attr("disabled", false);
            $("#busType").parent().parent().parent().find("#busParent3").nextAll().removeAttr("style");
            $("#busType").parent().parent().parent().find("#busRiskParent1").attr("disabled", false);
            $("#busType").parent().parent().parent().find("#busRiskParent1").nextAll().removeAttr("style");
            $("#busType").parent().parent().parent().find("#busActivationParent3").attr("disabled", false);
            $("#busType").parent().parent().parent().find("#busActivationParent3").nextAll().removeAttr("style");
        }
        var busTypeSelect=$("#busTypeSelect").val();
        if (busTypeSelect==2 || busTypeSelect==6) {
            $("#busTypeSelect").parent().parent().parent().find("#busTypeSelect").attr("disabled", true);
            $("#busTypeSelect").parent().parent().parent().find("#busTypeSelect").nextAll().attr("style","display: none");
        }
        if(busTypeSelect==2 ||busTypeSelect==6){
            $("#busTypeSelect").parent().parent().parent().find("#busParent1").attr("disabled", true);
            $("#busTypeSelect").parent().parent().parent().find("#busParent1").nextAll().attr("style","display: none");

            $("#busTypeSelect").parent().parent().parent().find("#busRiskParent3").attr("disabled", true);
            $("#busTypeSelect").parent().parent().parent().find("#busRiskParent3").nextAll().attr("style","display: none");

            $("#busTypeSelect").parent().parent().parent().find("#busActivationParent1").attr("disabled", true);
            $("#busTypeSelect").parent().parent().parent().find("#busActivationParent1").nextAll().attr("style","display: none");

            $("#busTypeSelect").parent().parent().parent().find("#busParent1").val("");
            $("#busTypeSelect").parent().parent().parent().find("#busParent2").attr("value","");
            $("#busTypeSelect").parent().parent().parent().find("#busRiskParent3").val("");
            $("#busTypeSelect").parent().parent().parent().find("#busRiskParent4").attr("value","");
            $("#busTypeSelect").parent().parent().parent().find("#busActivationParent1").val("");
            $("#busTypeSelect").parent().parent().parent().find("#busActivationParent2").attr("value","");
        }else{
            $("#busTypeSelect").parent().parent().parent().find("#busParent1").attr("disabled", false);
            $("#busTypeSelect").parent().parent().parent().find("#busParent1").nextAll().removeAttr("style");
            $("#busTypeSelect").parent().parent().parent().find("#busRiskParent3").attr("disabled", false);
            $("#busTypeSelect").parent().parent().parent().find("#busRiskParent3").nextAll().removeAttr("style");
            $("#busTypeSelect").parent().parent().parent().find("#busActivationParent1").attr("disabled", false);
            $("#busTypeSelect").parent().parent().parent().find("#busActivationParent1").nextAll().removeAttr("style");
        }
    });
