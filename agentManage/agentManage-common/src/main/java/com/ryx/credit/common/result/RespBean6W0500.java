...
public class RespBean6W0500 implements Serializable{
	...
	public void setbDealCode(String bDealCode) {
		this.bDealCode = bDealCode;
	}
	public String getbDealMessage() {
		return bDealMessage;
	}
	public void setbDealMessage(String bDealMessage) {
		this.bDealMessage = bDealMessage;
	}
