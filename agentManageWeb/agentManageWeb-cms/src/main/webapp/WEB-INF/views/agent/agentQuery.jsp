...
<div style="padding: 3px;">
    <form id="agentQueryForm" method="post">
    <input type="hidden" name="tempID" value="${Cagent.agentId}">
        <table class="grid">
                 ...
                 <tr>
                    ...
                    <td>代理商推广码</td>
                    <td><input name="agentCode" value="${Cagent.agentCode}" type="text" placeholder="请输入" class="easyui-validatebox" data-options="required:true" style="width:160px;"></td>
               	</tr>
                 <tr>
                    <td>公司简称</td>
                 ...
                 <tr>  
                    <td>申请时间</td>
                    <td><input name="applyDate" value="${Cagent.time}" type="text" placeholder="请输入" data-options="required:true" style="width:160px;"></td>
                    <td>注册手机</td>
