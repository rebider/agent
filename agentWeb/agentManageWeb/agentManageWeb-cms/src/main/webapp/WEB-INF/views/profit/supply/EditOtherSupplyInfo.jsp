...
<div class="easyui-panel" title="修改其他补款申请信息" data-options="iconCls:'fi-results'">
    <form id="otherSupplyEditFrom" method="post">
        <table class="grid">
            <input type="hidden" name="id" value="${pCityApplicationDetail.id}">
            <tr>
                <td width="200px">代理商唯一码：</td>
                <td><input id="agentId" name="agentId" value="${pCityApplicationDetail.agentId}" class="easyui-textbox" data-options="editable:false" style="width:270px;"></td>
            </tr>
            <tr>
