...
public interface OPaymentDetailMapper {
    ...
    BigDecimal selectQk(@Param("orderId")String orderId, @Param("time")String time);
    ...
    OPaymentDetail selectoPaymentDetail(@Param("orderId")String orderId, @Param("time")String time);
}