...
<link rel="shortcut icon" href="${staticPath }/static/style/images/bitbug_favicon.ico" />
<%-- [my97日期时间控件] --%>
...
<script type="text/javascript" src="${staticPath }/static/common/common.js?version=20180907" charset="utf-8"></script>
<%-- [扩展样式] --%>
...
<script type="text/javascript">
    ...
    var mainLoginUserId = "${MainLoginUserId}";
</script>