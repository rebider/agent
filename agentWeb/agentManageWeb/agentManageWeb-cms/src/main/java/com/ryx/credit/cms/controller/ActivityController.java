...
public class ActivityController extends BaseController{
    ...
    public Object start(final HttpServletRequest request,
        ...
        activityService.createDeloyFlow("团建工作流1",id, AppConfig.getProperty("activity_path"), AppConfig.getProperty("activity_image_path"),null);
        return "OK";
    }
    ...
    public Object task(final HttpServletRequest request,
        ...
        //返回对象
        TreeMap<String, String> treeMap = getRequestParameter(request);
        List<Task> taskList = activityService.findMyPersonTask(treeMap.get("user"),treeMap.get("group"));
...
//    }
    ...
    /**
     * 打开流程图显示页面
     * /activity/openActivitiProccessImagePage
     **/
