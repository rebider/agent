...
//                        $(srcData.target).parent().parent().parent().find("select[name='busScope']").attr("disabled","disabled");
    ...
    $(function(){
        ...
        var busType_ = $("#busDiv #busSelect").val();
        $("#busDiv #busSentDirectly").attr("disabled", true);
        if (busType_=='8'){
            $("#busDiv #busSentDirectly").val('0');
        }else{
            $("#busDiv #busSentDirectly").val('1');
        }
    });
...
//        data.agentAssProtocol = $(table).find("select[name='agentAssProtocol']").val();
    ...
    function changBus(o){
        ...
        if(platformType=='POS' ||  platformType=='ZPOS' ||  platformType=='ZHPOS' ||  platformType=='SSPOS'){
