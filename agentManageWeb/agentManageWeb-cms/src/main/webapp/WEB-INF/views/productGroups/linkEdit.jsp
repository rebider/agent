...
<div style="padding: 3px;">
    <form id="productLinkEditForm" method="post">
        <table class="grid">
                <tr>
	                <td>产品组</td>
	                <td colspan="1"><input name="id" type="hidden"  value="${link.id}"><select id="LinkGrouptId" name="parentProductGroup" style="width:300px;height: 29px;" data-options="required:true"></select>
