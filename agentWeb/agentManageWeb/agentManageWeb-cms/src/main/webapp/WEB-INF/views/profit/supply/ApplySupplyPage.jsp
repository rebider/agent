...
<script type="text/javascript">
    ...
    $(function(){
        $("#applicationDeductionForm").form({
            url:"${path}/profitSupply/commitInfo",
            onSubmit : function() {
        ...
        <form id="applicationDeductionForm" method="post">
            <table>
                ...
                <tr>
                    <td>上级代理商唯一码：</td>
                    <td>
                        <input id="parentAgentId" name="parentAgentId"  type="text"<c:if test="${isagent.isOK()}">value="${isagent.data.agUniqNum}"</c:if>  style="width:200px;" />
                ...
                <tr>
                    <td>上级代理商名称：</td>
                    <td>
                        <input id="parentAgentName" name="parentAgentName" value="" <c:if test="${isagent.isOK()}">value="${isagent.data.agName}"</c:if> class="easyui-validatebox"  readonly="readonly" style="width:200px;">
                    </td>
                </tr><tr/>
                <tr>
                    <td>补款金额：</td>
