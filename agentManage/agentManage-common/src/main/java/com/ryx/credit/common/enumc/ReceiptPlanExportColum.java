...
public enum ReceiptPlanExportColum {
    ...
    ReceiptPlanExportColum_title("排单编号,订单编号,商品编号,商品ID,商品名称,唯一码,代理商,平台,机具类型,活动,已排单总数量,排单数量,剩余未排单数量,订货厂家,已发货数量,机型,收货人姓名,收货人联系电话,省,市,区,详细地址,地址备注,邮编,快递备注,配货时间,创建时间,发货时间(2018-01-01),发货数量,物流公司,物流单号,起始SN序列号,结束SN序列号,起始SN位数,结束SN位数,是否联动,领导审批意见","排单导出标题"),
