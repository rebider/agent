...
public interface OrderOffsetService {
     ...
     * @return
     */
    AgentResult OffsetArrearsComit(BigDecimal amount, String OffsetPaytype, String srcId);
     ...
     * @return
     */
    AgentResult OffsetArrearsCancle(BigDecimal amount, String OffsetPaytype, String srcId);
