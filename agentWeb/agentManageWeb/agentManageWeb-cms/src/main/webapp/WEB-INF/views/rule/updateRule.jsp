        ...
        <form id="ruleUpdateForm" method="post">
            <table class="grid">
                <tr>
                 ...
                 <tr>
                    <td>开启时间</td>
                    <td><input class="easyui-datetimebox" name="validStartTime" data-options="required:true"  style="width:150px"
                               value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${cRule.validStartTime}' />"
                    >  </td>
                </tr>
                <tr>
                    <td>结束时间</td>
                    <td><input class="easyui-datetimebox" name="validEndTime"  data-options="required:true"  style="width:150px"
                               value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${cRule.validEndTime}'/>  </td>
                </tr>
                <tr>
                    <td>产品</td>
                    <td>
