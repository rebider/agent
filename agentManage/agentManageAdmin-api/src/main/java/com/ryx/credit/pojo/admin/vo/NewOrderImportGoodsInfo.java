...
public class NewOrderImportGoodsInfo implements Serializable {
    ...
    public void loadInfoFromJsonArray(JSONArray data, String importId){
        if(data!=null){
            ...
            this.setSendOutNum((colum.indexOf("sendOutNum")<data.size())?data.getString(colum.indexOf("sendOutNum")):"");
            this.setReturnsNum((colum.indexOf("returnsNum")<data.size())?data.getString(colum.indexOf("returnsNum")):"");
        }
