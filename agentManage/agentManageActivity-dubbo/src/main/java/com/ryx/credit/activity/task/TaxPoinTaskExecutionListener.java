...
/**
 * TaxPoinTaskExecutionListener
 * Created by IntelliJ IDEA.
 * 税点调整
 * @author Wang Qi
 * @version 1.0 2018/7/27 19:08
 * @see TaxPoinTaskExecutionListener
 * To change this template use File | Settings | File Templates.
 */

public class TaxPoinTaskExecutionListener  extends BaseTaskListener implements TaskListener, ExecutionListener {
    private static final Logger logger = LoggerFactory.getLogger(TaxPoinTaskExecutionListener.class);
    ...
    public void notify(DelegateExecution delegateExecution) throws Exception {
        ...
        if ("start".equals(eventName)) {
            ...
            //数据变更服务类
            IPTaxAdjustService taxAdjustService = (IPTaxAdjustService) MySpringContextHandler.applicationContext.getBean("iPTaxAdjustService");
            //审批拒绝
            ...
            if ("finish_end".equals(activityName)) {
                taxAdjustService.completeTaskEnterActivity(delegateExecution.getProcessInstanceId(), activityName);
                logger.info("=========RefundTaskExecutionListener 流程{}eventName{}res{}", delegateExecution.getProcessInstanceId(), eventName, "");
            }
