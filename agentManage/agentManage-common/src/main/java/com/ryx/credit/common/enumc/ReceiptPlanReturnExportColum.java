...
public enum ReceiptPlanReturnExportColum {
    ...
    ReceiptPlanExportColum_column("PLAN_NUM,ORDER_ID,PRO_CODE,PRO_ID,PRO_NAME,PRO_TYPE,ACTIVITY_NAME,PLAN_PRO_NUM,PRO_COM_STRING,PLAN_PRO_NUM,MODEL,ADDR_REALNAME,ADDR_MOBILE,NAME,CITY,DISTRICT,ADDR_DETAIL,REMARK,ZIP_CODE,EXPRESS_REMARK,C_DATE,h,g,a,b,c,d,e,f","排单导出字段"),
