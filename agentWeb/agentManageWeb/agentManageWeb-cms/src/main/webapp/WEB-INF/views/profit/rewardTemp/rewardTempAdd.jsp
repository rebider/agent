    ...
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="posRewardTempAddForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>奖励比例：</td>
                    <td><input type="text" id="proportion" name="proportion"  class="easyui-numberbox"  placeholder="请输入奖励比例" class="easyui-validatebox" data-options="required:true,min:0,precision:5"></td>
                </tr>
                <tr>
                    <td>活动生效月份：</td>
                    <td>
                        <input type="text" id="activityValidStart" name="activityValidStart" placeholder="活动生效分润月开始" class="easyui-validatebox" data-options="required:true">&nbsp;至&nbsp;
                        <input type="text" id="activityValidEnd" name="activityValidEnd" placeholder="活动生效分润月结束" class="easyui-validatebox" data-options="required:true">
                    </td>
                </tr>
            </table>
        </form>
