...
public class AgentVo implements Serializable {
    ...
    private List<String > terminalTransferFNoorbidde;

    public List<String> getTerminalTransferFNoorbidde() {
        return terminalTransferFNoorbidde;
    }

    public void setTerminalTransferFNoorbidde(List<String> terminalTransferFNoorbidde) {
        this.terminalTransferFNoorbidde = terminalTransferFNoorbidde;
    }
   ...
   private  String invoiceReturnReason;
    ...
    public List<AgentBusInfoVo> getEditDebitList() {
        return editDebitList;
    }

    public void setEditDebitList(List<AgentBusInfoVo> editDebitList) {
        this.editDebitList = editDebitList;
    }

    public List<AgentBusInfoVo> getTerminalsLowerList() {
        return terminalsLowerList;
    }
    ...
    public List<AgentBusInfoVo> getOrgTypeList() {
        return orgTypeList;
    }
