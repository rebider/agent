...
<div class="easyui-tabs" id="taskAppTabs">
    ...
    <shiro:hasPermission name="/thaw/approvalUpdate">
        <%@ include file="taskToolsDeductEdit.jsp" %>
    </shiro:hasPermission>
    <shiro:hasPermission name="/thaw/approvalUpdate">
        <c:if test="${profitDeduction.stagingStatus != 5}">
            <div >
                <a href="javascript:void(0)" class="easyui-linkbutton" style="width: 200px;align-content: center" data-options="iconCls:'fi-save'" onclick="editToolsDeduct()" >保存修改信息</a>
            </div>
        </c:if>
    </shiro:hasPermission>
    <%--审批意见--%>
