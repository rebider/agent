package com.ryx.credit.cms.shiro.captcha;

import com.ryx.credit.common.util.EnvironmentUtil;
import com.ryx.credit.commons.utils.StringUtils;
import com.ryx.credit.commons.utils.WebUtils;
...
public class DreamCaptcha implements InitializingBean {
	...
	public void generate(HttpServletRequest request, HttpServletResponse response) {
		...
		String captchaCode ="AAAA";
		if(EnvironmentUtil.isProduction()){
			captchaCode = CaptchaUtils.generateCode().toUpperCase();// 转成大写重要
		}
		// 不存在cookie时设置cookie
		if (!hasCookie) {
