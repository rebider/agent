...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="conditionValueAddForm" method="post">
            <table class="grid">
                <tr>
                 ...
                 <tr>
                    <td>条件</td>
                    <td><input id="condition" name="condition" data-options="required:true" style="width:150px"></td>
                </tr>
                <tr>
                    <td>操作</td>
                    <td ><input id="operate" name="operate" data-options="required:true" style="width:150px"></td>
                </tr>
                <tr>
                    <td>值</td>
                    <td >
                        <input name="value" id="value" class="easyui-validatebox" data-options="required:true" style="width:150px"/>
                    </td>
                </tr>
            </table>
        </form>
