...
public class DateUtil{
	    ...
	    public static void main(String[] args) {  
	        ...
	        String str="2017-05-01 10:31:45";
	        String a="'"+str.substring(0,10)+"'"; // or  str=str.Remove(i,str.Length-i); 
	        String b="||'"+str.substring(11,str.length())+"'";
