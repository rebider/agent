...
//                $('.agentinlist-sjxgsq-easyui-linkbutton-edit').linkbutton({text: '申请修改'});
                $('.agentinlist-zhsq-easyui-linkbutton-edit').linkbutton({text: '基础信息修改'});
    ...
    function agentQueryCity(id, agStatus) {
        addTab({
            title: '代理商操作-查看' + id,
            border: false,
            closable: true,
            fit: true,
            href: '/agentEnter/agentQueryCity?id=' + id +"&agStatus=" + agStatus +"<shiro:hasPermission name="/agent/agentIsZpos">&isZpos=true</shiro:hasPermission><shiro:hasPermission name="/agent/agentIsZposAll">&isZpos=all</shiro:hasPermission>"
        });
    }
    ...
    function agentEdit(id) {
        addTab({
            ...
            closable: true,
            fit: true,
            href: '/agentEnter/agentByid?id=' + id+"&editWatch="+"666"
        });
    }
