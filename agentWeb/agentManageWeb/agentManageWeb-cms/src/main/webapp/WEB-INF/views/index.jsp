...
<script type="text/javascript">
    ...
    function refreshTabIndex(index) {
        var tab = index_tabs.tabs('getTab', index);
        var options = tab.panel('options');
        if (options.content) {
            index_tabs.tabs('update', {
...
<body>
    ...
    <div id="index_layout">
        <div class="topback" data-options="region:'north',border:false" style="overflow: hidden;">
            <div>
                ...
                <span style="float: left; padding-left: 5px; margin-top: 15px; color: #fff;font-size:20px" >
                	瑞银信代理商综合管理平台
                </span>
            </div>
        </div>
    ...
    <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2017 power by <a href="http://www.ruiyinxin.com/" target="_blank">瑞银信©</a></div>
    </div>
    <div id="tabsMenu">
